...
public class MainActivity extends AppCompatActivity {
    ...
    private void launchCamera() {
        ...
        // If you call starActivityForResult() using an intent that no app can handle, your app will crash.
    ...
    public File getPhotoFileUri(String filename){
        ...
        // This way, we don't need o request external read/write runtime permission.
